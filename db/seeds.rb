...
users = User.create!([
  {name: "John", last_name: 'Doe', email: "johndoe@mail.ru", password: 'secret'},
  {name: "Jane", last_name: 'Doe', email: "janedoe@mail.ru", password: 'secret'},
  {name: "Harry", last_name: 'Potter', email: "harrypotter@mail.ru", password: 'secret'}
])
