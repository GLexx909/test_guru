...
users = User.create!([
  {name: "John Doe", email: "johndoe@mail.ru", password: 'secret'},
  {name: "Jane Doe", email: "janedoe@mail.ru", password: 'secret'},
  {name: "Harry Potter", email: "harrypotter@mail.ru", password: 'secret'}
])
